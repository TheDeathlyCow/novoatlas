...
The `avila-basic-example` data pack provides a basic template for creating NovoAtlas worlds based on the Overworld. The other example data packs that provide examples for how to do specific common or complicated things with NovoAtlas, and they load their changes in separate dimensions. See their respective READMEs for more details.
